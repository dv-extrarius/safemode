#Initialize for any new players
...
#Food
execute as @a unless score @s smFood matches 0..1 run scoreboard players operation @s smFood %= #2 Constant
...
#Health
execute as @a unless score @s smHealth matches 0..1 run scoreboard players operation @s smHealth %= #2 Constant
...
#Slow Fall
execute as @a unless score @s smSlowFall matches 0..1 run scoreboard players operation @s smSlowFall %= #2 Constant
execute as @a if score @s smSlowFall matches 1 run effect give @p minecraft:slow_falling 1 0 true

#Invisibility
execute as @a unless score @s smInvisibility matches 0..1 run scoreboard players operation @s smInvisibility %= #2 Constant
execute as @a if score @s smInvisibility matches 1 run effect give @a minecraft:invisibility 1 10 true

#Water Breathing
execute as @a unless score @s smWaterBreathing matches 0..1 run scoreboard players operation @s smWaterBreathing %= #2 Constant
